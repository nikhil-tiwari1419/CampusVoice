...
const faqItems = [
  {
    ...
    answer:
      'No. When you submit a complaint under the anonymous option, your student ID, email address, and personal profile are cryptographically stripped before the complaint reaches the department dashboard. Administrators only see the complaint content and category.',
  },
  {
    category: 'Process',
    question: 'How long does it typically take to receive a response?',
    answer:
      'Initial acknowledgments are generated immediately. An assigned department officer reviews complaints within 24 to 48 working hours. Critical infrastructure or safety complaints are flagged with high priority for expedited review.',
  },
  {
    category: 'Process',
    question: 'What happens after I submit a grievance?',
    answer:
      'Your complaint is automatically categorized and routed to the respective cell (e.g., Hostel Committee, Academic Cell). The officer updates the status from "Pending" to "In Progress" once under review, and you can track every step directly on your dashboard.',
  },
  {
    category: 'General',
  ...
  },
  {
    ...
    answer:
      'If an issue marked "Resolved" persists, you can raise a follow-up complaint referencing the original complaint ID (e.g., CMP-1042) or contact the student affairs representative directly through the Help Desk.',
  },
]
