        ...
        <div className="bg-white border border-slate-200/80 rounded-2xl p-6 sm:p-8 shadow-lg shadow-slate-200/40 backdrop-blur-xl">
          ...
          {!submitted ? (
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <label htmlFor="otp" className="block text-xs font-medium text-slate-700">
                  ...
                  {errors.otp && <p className="text-xs text-rose-600 mt-1.5">{errors.otp}</p>}
                </div>
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-teal-600 hover:bg-teal-700 text-white font-semibold text-sm rounded-xl py-2.5 mt-3 transition-all shadow-md shadow-teal-600/20 hover:shadow-teal-600/30 active:scale-[0.99] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 cursor-pointer"
                >
            ...
            <div className="flex flex-col items-center gap-3 py-4 text-center animate-in fade-in zoom-in-95 duration-200">
              ...
              <h2 className="text-xl font-bold text-slate-900 tracking-tight">Account Verified!</h2>
