        ...
        <div className="bg-[#0F172A]/80 border border-slate-800/80 rounded-2xl p-6 sm:p-8 shadow-2xl shadow-black/80 backdrop-blur-xl">
            ...
            <div>
              <div className="text-center mb-6">
                ...
                <p className="text-xs sm:text-sm text-slate-400 mt-1.5">
                  Code sent to <span className="text-teal-400 font-medium">{email}</span>
                </p>
              </div>
              ...
              <form onSubmit={handleResetPassword} noValidate className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <label htmlFor="reset-otp" className="block text-xs font-medium text-slate-300">
                      Recovery OTP
                    </label>
                  ...
                  {errors.otp && (
                    <p className="text-xs text-rose-400 mt-1.5">{errors.otp}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.newPassword && (
                    <p className="text-xs text-rose-400 mt-1.5">{errors.newPassword}</p>
                  )}
                </div>

                {/* Confirm New Password */}
                <div>
                  <label htmlFor="confirm-new-password" className="block text-xs font-medium text-slate-300 mb-1.5">
                    Confirm New Password
                  </label>
                  <div className="relative">
                    <Lock className="w-4 h-4 text-slate-500 absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none" />
                  ...
                  {errors.confirmPassword && (
                    <p className="text-xs text-rose-400 mt-1.5">{errors.confirmPassword}</p>
                  )}
                </div>
                ...
                <div className="flex items-center justify-between text-xs pt-1">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 text-teal-400 hover:text-teal-300 disabled:text-slate-600 transition-colors cursor-pointer disabled:cursor-not-allowed font-medium"
                  >
          ...
          {step === 3 && (
            <div className="flex flex-col items-center gap-3 py-4 text-center animate-in fade-in zoom-in-95 duration-200">
              ...
              <h2 className="text-xl font-bold text-slate-100 tracking-tight">Password Changed!</h2>
